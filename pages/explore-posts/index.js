...
const ExplorePosts = () => {
    ...
    const getFirstData = () => {
        ...
        getAllPostWithCoordinates(body);
    }
    ...
    const fetchItems = async () => {
        if (hasMoreItems && !isLoading) {
            ...
            await getAllPostWithCoordinates(body);
        }
    };
    ...
    return (
        <Layout>
            ...
            {isLoading && firstFetch ? (
                ...
                <div>
                    <h1 className="text-2xl text-center">All Post with Coordinates</h1>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <h2 className="flex justify-start items-center">
                                        Coordinate:{" "}
                                        <span
                                            className={`font-bold ${post?.coordinate_status
                                                    ? "text-green-900"
                                                    : "text-red-900"
                                                }`}
                                        >
